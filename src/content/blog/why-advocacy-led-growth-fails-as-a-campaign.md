...
**Identify the highest-potential community and interaction point.** Not every audience segment will advocate. Not every interaction generates a completion moment worth activating. A certification graduating cohort of 30 developers has a different advocacy potential than a webinar audience of 500 passive viewers. The [Readiness Diagnostic](/toolkit/readiness-diagnostic.html) and [Completion Moment Audit](/toolkit/completion-moment-audit.html) exist to answer this question: where is advocacy structurally most likely to compound?
